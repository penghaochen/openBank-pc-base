      ...
      <Table border :columns="columns" :data="data" :loading="loading">
        ...
        <template slot="action" slot-scope="{ row }">
          <a @click="handleModal(row)"
             :disabled="row.roleCode != 'all' ?false:true">编辑</a>&nbsp;
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleSearch (page) {
        this.data=[{"createTime":"2018-07-29 21:14:54","updateTime":"2019-05-25 03:06:57","roleId":"1","roleCode":"admin","roleName":"系统管理员","roleDesc":"系统管理员","status":1,"isPersist":1},{"createTime":"2018-07-29 21:14:54","updateTime":"2019-05-25 15:14:56","roleId":"2","roleCode":"operator","roleName":"运营人员","roleDesc":"运营人员","status":1,"isPersist":1},{"createTime":"2018-07-29 21:14:54","updateTime":"2019-05-25 15:17:07","roleId":"3","roleCode":"support","roleName":"客服","roleDesc":"客服","status":1,"isPersist":1}]
        // if (page) {
